...
export const mockFoodItems: FoodItem[] = [
  ...
  },
  {
    ...
    category: 'Bánh mỳ',
    image: 'https://picsum.photos/seed/bread1/800/600',
    rating: 4.7,
    expiryTime: 'Hết hạn sau 1h',
    remainingCount: 3,
    description: 'Bánh mỳ hoa cúc thơm lừng, mềm mịn.',
    impactCo2: 1.0,
  },
  {
    id: 'f6',
    ...
    category: 'Bánh kem',
    image: 'https://picsum.photos/seed/cake1/800/600',
    rating: 4.9,
    expiryTime: 'Kết thúc sau 2h',
    remainingCount: 1,
    description: 'Bánh kem trà xanh thanh mát, ít ngọt.',
    impactCo2: 2.0,
  },
  {
    id: 'f7',
    ...
    discountPercentage: 62,
    category: 'Bánh kem',
    image: 'https://picsum.photos/seed/cake2/800/600',
    rating: 4.8,
    expiryTime: 'Kết thúc sau 1.5h',
    remainingCount: 2,
    description: 'Bánh kem socola đậm đà, cốt bánh mềm.',
    impactCo2: 1.8,
  },
  {
    id: 'f8',
    ...
    category: 'Đồ uống',
    image: 'https://picsum.photos/seed/drink1/800/600',
    rating: 4.6,
    expiryTime: 'Cách 0.5 km',
    remainingCount: 4,
    description: 'Sinh tố bơ sáp thơm ngon, bổ dưỡng.',
    impactCo2: 0.3,
  },
];
